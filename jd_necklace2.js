/*
点点券2，可以兑换无门槛红包（1元，5元，10元，100元，部分红包需抢购）
...
[task_local]
#点点券2
10 0,20 * * * jd_necklace2.js, tag=点点券, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true

================Loon==============
[Script]
cron "10 0,20 * * *" script-path=jd_necklace2.js,tag=点点券2

===============Surge=================
点点券2 = type=cron,cronexp="10 0,20 * * *",wake-system=1,timeout=3600,script-path=jd_necklace2.js

============小火箭=========
点点券2 = type=cron,script-path=jd_necklace2.js, cronexpr="10 0,20 * * *", timeout=3600, enable=true
 */
